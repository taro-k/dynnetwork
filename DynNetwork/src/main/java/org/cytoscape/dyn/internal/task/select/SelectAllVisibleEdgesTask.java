 ...
 *
 */
public class SelectAllVisibleEdgesTask extends AbstractSelectTask 
{
	...
	public void run(TaskMonitor tm) throws Exception 
	{
		...
		tm.setProgress(0.2);
		selectUtils.setSelectedEdges(network,CyTableUtil.getEdgesInState(network, CyNetwork.SELECTED, false), true, start, end);
		tm.setProgress(0.6);
		updateView();
		tm.setProgress(1.0);
	}
