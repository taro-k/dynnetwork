...
import org.cytoscape.dyn.internal.view.layout.algorithms.standard.KKLayout;
import org.cytoscape.dyn.internal.view.layout.algorithms.standard.UnweightedShortestPath;
 ...
 * @param <T>
 */
public class DynKKLayoutAlgorithmTask<T> extends AbstractLayoutTask 
{
	 ...
	 * @param maxTime
	 */
    public DynKKLayoutAlgorithmTask(
                    final String name,
