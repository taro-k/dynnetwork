 ...
 * @param <C>
 */
public class SmoothKKDynLayout<T,C> extends AbstractLayoutAlgorithm
{
                    ...
                    String layoutAttribute)
    {
            ...
            return new TaskIterator(new SmoothKKDynLayoutTask<T>(
            		getName(), 
            		layout, 
