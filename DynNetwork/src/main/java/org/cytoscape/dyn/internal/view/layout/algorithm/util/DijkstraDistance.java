...
package org.cytoscape.dyn.internal.view.layout.algorithm.util;
...
public class DijkstraDistance<T> implements Distance<T>
{
    ...
    protected Map<CyEdge, ? extends Number> nev;
     ...
     * @param cached
     */
    public DijkstraDistance(DynNetworkSnapshot<T> g, Map<CyEdge, ? extends Number> nev, boolean cached) 
    {
        this.g = g;
        this.nev = nev;
