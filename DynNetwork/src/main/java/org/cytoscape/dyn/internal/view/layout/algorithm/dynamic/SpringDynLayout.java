...
/**
 * <code> SpringDynLayout </code> instantiate the dynamic layout algorithm task 
 * {@link SpringDynLayoutTask}.
 * 
 ...
 * @param <C>
 */
public class SpringDynLayout<T,C> extends AbstractLayoutAlgorithm
{
    ...
    /**
     * <code> SpringDynLayout </code> constructor.
     * @param computerName
     * @param humanName
     * @param undoSupport
     * @param panel
                    ...
                    String layoutAttribute)
    {
            ...
            return new TaskIterator(new SpringDynLayoutTask<T>(
            		getName(), 
            		layout, 
