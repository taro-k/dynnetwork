...
/**
 * <code> RandomDynLayout </code> instantiate the dynamic layout algorithm task 
 * {@link RandomDynLayoutTask}.
 * 
 ...
 * @param <C>
 */
public class RandomDynLayout<T,C> extends AbstractLayoutAlgorithm
{
    ...
    /**
     * <code> RandomDynLayout </code> constructor.
     * @param computerName
     * @param humanName
     * @param undoSupport
     * @param panel
                    ...
                    String layoutAttribute)
    {
            ...
            return new TaskIterator(new RandomDynLayoutTask<T>(
            		getName(), 
            		layout, 
