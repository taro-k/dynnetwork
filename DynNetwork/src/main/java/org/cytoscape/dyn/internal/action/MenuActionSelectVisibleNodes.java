...
public class MenuActionSelectVisibleNodes<T,C> extends AbstractCyAction
{
    ...
    public void actionPerformed(ActionEvent e)
    {
    	...
    	SelectAllVisibleNodesTaskFactoryImpl selectAllNodesTaskFactory = new SelectAllVisibleNodesTaskFactoryImpl(undoSupport,viewManager,cyEventHelper,timeInterval.getStart(),timeInterval.getEnd());
